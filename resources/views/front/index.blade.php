					...
					<div class="row mt-30">
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('assets/front/images/banners/small/1.jpg') }}" alt="" />
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-sm-20">
								<img src="{{ asset('assets/front/images/banners/small/2.jpg') }}" alt="" />
								<div class="banner-info">
									<h4>Tech</h4>
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-20">
								<img src="{{ asset('assets/front/images/banners/small/3.jpg') }}" alt="" />
								<div class="banner-info">
									<h4>Beauty</h4>
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-20">
								<img src="{{ asset('assets/front/images/banners/small/4.jpg') }}" alt="" />
								<div class="banner-info">
									<h4>Electronics</h4>
				...
				<div class="col-xl-2 col-lg-3">
					<div class="sidebar">
							...
							<div class="row product-deals">
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/deals/1.jpg') }}" alt="" /></a>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/1.jpg') }}" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/3.jpg') }}" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/4.jpg') }}" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
						...
						<div class="sidebar-single mt-30 d-none d-xl-block">
							<a href="#"><img src="{{ asset('assets/front/images/ad/1.jpg') }}" alt="" /></a>
						</div>
						<!--latest-products-->
											...
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('assets/front/images/products/latest/1.jpg') }}" alt="" /></a>
														</div>
													</div>
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('assets/front/images/products/latest/2.jpg') }}" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('assets/front/images/products/latest/3.jpg') }}" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('assets/front/images/products/latest/4.jpg') }}" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('assets/front/images/products/latest/5.jpg') }}" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
								...
								<ul class="list-none">
									<li>
										<div class="support-icon">
											<img src="{{ asset('assets/front/images/icons/bank-loan.jpg') }}" alt="" />
										</div>
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('assets/front/images/icons/bank-liquidity.jpg') }}" alt="" />
										</div>
										<div class="support-text">
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('assets/front/images/icons/bank-credit-card.jpg') }}" alt="" />
										</div>
										<div class="support-text">
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('assets/front/images/icons/bank-support.jpg') }}" alt="" />
										</div>
										<div class="support-text">
				...
				<div class="col-xl-10 col-lg-9 fix">
						...
						<div class="row product-categories-carousel mt-30">
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('assets/front/images/products/category/1.png') }}" alt="" /></a>
									<h4><a href="#">Sports & Outdoors</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('assets/front/images/products/category/2.png') }}" alt="" /></a>
									<h4><a href="#">Headphones</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('assets/front/images/products/category/3.png') }}" alt="" /></a>
									<h4><a href="#">Smart phone & Tablets</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('assets/front/images/products/category/4.png') }}" alt="" /></a>
								...
								<div class="row product-carousel cv-visible">
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/2.jpg') }}" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/5.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/6.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/7.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/8.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
								...
								<div class="row product-carousel cv-visible">
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/1.jpg') }}" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/2.jpg') }}" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/3.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/4.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
								...
								<div class="row product-carousel cv-visible">
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/5.jpg') }}" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/6.jpg') }}" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/7.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('assets/front/images/products/shop/8.jpg') }}" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
						...
						<div class="row best-seller cv-visible">
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/products/9.jpg') }}" alt="" /></a>
										<div class="downsale"><span>-</span>$25</div>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/products/10.jpg') }}" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/products/11.jpg') }}" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/products/12.jpg') }}" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/products/13.jpg') }}" alt="" /></a>
										<div class="downsale"><span>-</span>$25</div>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
					...
					<div class="row mt-40">
						<div class="col-xl-4 col-lg-6">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('assets/front/images/banners/md/1.jpg') }}" alt="" />
								<div class="banner-info">
						...
						<div class="col-xl-4 col-lg-6 mt-sm-30">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('assets/front/images/banners/md/2.jpg') }}" alt="" />
								<div class="banner-info">
									<div class="product-value">
										<span>$345.00</span>
										<del>$429.99</del>
						...
						<div class="col-xl-4 col-lg-6 d-none d-xl-block">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('assets/front/images/banners/md/3.jpg') }}" alt="" />
								<div class="banner-info">
									<div class="product-value">
										<span>$345.00</span>
										<del>$429.99</del>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/14.jpg') }}" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/shop/10.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/shop/11.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/15.jpg') }}" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/16.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/17.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/18.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/19.jpg') }}" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('assets/front/images/products/20.jpg') }}" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
					...
					<div class="sidebar-single">
						...
						<div class="row blog-carousels mt-30">
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/blog/sm/1.jpg') }}" alt="" /></a>
									</div>
							...
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/blog/sm/2.jpg') }}" alt="" /></a>
									</div>
									<div class="blog-carousel-desc">
										<small>22 Apr 2019</small>
										<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
							...
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('assets/front/images/blog/sm/3.jpg') }}" alt="" /></a>
									</div>
									<div class="blog-carousel-desc">
										<small>22 Apr 2019</small>
										<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
						...
						<div class="col-lg-4">
							...
							<div class="product-single style-2">
								<div class="row align-items-center">
									<div class="col-lg-6 p-0">
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/21.jpg') }}" alt="" /></a>
										</div>
									</div>
									<div class="col-lg-6 p-0">
										<div class="product-title">
							...
							<div class="product-single style-2">
								<div class="row align-items-center">
									<div class="col-lg-6 p-0">
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('assets/front/images/products/23.jpg') }}" alt="" /></a>
										</div>
									</div>
									<div class="col-lg-6 p-0">
										<div class="product-title">
				...
				<div class="col-lg-12">
					<div class="brand-items">
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/1.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/2.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/3.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/4.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/5.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/6.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/7.jpg') }}" alt="" />
							</a>
						</div>
						<div class="brand-item">
							<a href="#">
								<img class="brand-static" src="{{ asset('assets/front/images/brands/8.jpg') }}" alt="" />
							</a>
						</div>
					</div>
				</div>
